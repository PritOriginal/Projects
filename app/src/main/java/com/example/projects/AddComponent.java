...
import com.example.projects.server.AddComponentProject;
import com.example.projects.server.GetAllComponents;
...
public class AddComponent extends AppCompatActivity implements View.OnClickListener, OnComponentsListener, android.widget.SearchView.OnCloseListener, android.widget.SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GetAllComponents task = new GetAllComponents(this,this, progressBar);
        task.execute();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.addComponentsInProject:
                ...
                AddComponentProject task = new AddComponentProject(this, id, idComponent, countComponent);
                task.execute();
