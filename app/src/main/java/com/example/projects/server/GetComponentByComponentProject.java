...
public class GetComponentByComponentProject extends AsyncTask<URL, Integer, ArrayList<Component>> {
    Context mContext;
    private OnComponentsListener mListener;
    ArrayList<Component> components = new ArrayList<Component>();
    int id;

    public GetComponentByComponentProject (Context mContext, OnComponentsListener mListener, int id) {
