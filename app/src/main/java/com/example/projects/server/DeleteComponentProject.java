...
public class DeleteComponentProject extends AsyncTask<URL, Integer, ArrayList<String>> {
    Context mContext;
    ArrayList<String> request = new ArrayList<String>();
    int id;

    public DeleteComponentProject(Context mContext, int id){
    ...
    protected ArrayList<String> doInBackground(URL... urls) {
        ...
        params.put("REQUEST", "deleteComponentProject");
