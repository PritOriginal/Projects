...
public class AddProject extends AsyncTask<URL, Integer, ArrayList<String>>  {
    Context mContext;
    ArrayList<String> request = new ArrayList<String>();
    int id;
    String name;
    String description;
    public AddProject (Context mContext, int id, String name, String description){
