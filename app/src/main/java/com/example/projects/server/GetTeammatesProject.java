...
import com.example.projects.OnTeammatesListener;
...
public class GetTeammatesProject extends AsyncTask<URL, Integer, ArrayList<User>> {
    ...
    public GetTeammatesProject(Context mContext, OnTeammatesListener mListener, int id, ProgressBar progressBar) {
