...
public class AddObjective extends AsyncTask<URL, Integer, ArrayList<String>> {
    Context mContext;
    ArrayList<String> request = new ArrayList<String>();
    int id;
    String objective;

    public AddObjective (Context mContext, int id, String objective) {
    ...
    protected ArrayList<String> doInBackground(URL... urls) {
        ...
        params.put("REQUEST", "addObjective");
