...
public class ChangeProject extends AsyncTask<URL, Integer, ArrayList<String>> {
    Context mContext;
    ArrayList<String> request = new ArrayList<String>();
    int id;
    String name;
    String description;
    public ChangeProject (Context mContext, int id, String name, String description){
    ...
    protected ArrayList<String> doInBackground(URL... urls) {
        ...
        params.put("REQUEST", "changeProject");
