...
import com.example.kvantorium.server.GetComponent;
...
public class ComponentsInfo extends AppCompatActivity implements OnComponentsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fromProject) {
            GetComponentByComponentProject getComponentByComponentProject = new GetComponentByComponentProject(this, id);
            getComponentByComponentProject.execute();
        } else {
            GetComponent getComponent = new GetComponent(this, id);
